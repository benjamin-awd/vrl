...
pub const DECIMAL: u16 = 1 << 4;
pub const BOOLEAN: u16 = 1 << 5;
pub const OBJECT: u16 = 1 << 6;
pub const ARRAY: u16 = 1 << 7;
pub const TIMESTAMP: u16 = 1 << 8;
pub const REGEX: u16 = 1 << 9;
pub const NULL: u16 = 1 << 10;
pub const UNDEFINED: u16 = 1 << 11;
